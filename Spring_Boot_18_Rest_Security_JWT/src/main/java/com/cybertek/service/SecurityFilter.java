...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest,
        ...
        // header ın authorization başlığındaki bilgiyi al....
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtUtil.validateToken(token, userDetails) && checkIfUserIsValid(username)) {
                ...
                UsernamePasswordAuthenticationToken currentUser = new UsernamePasswordAuthenticationToken(userDetails, null, userDetails.getAuthorities());
